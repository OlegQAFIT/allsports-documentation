...
3](#о-системе-allsports-и-панели-пользователя)

> [1.1. Уровни подписки 3](#уровни-подписки)

[2. Регистрация в Панели пользователя
4](#регистрация-в-панели-пользователя)

> [2.1. Переход по ссылке работодателя
> 4](#переход-по-ссылке-работодателя)
>
> [2.2. Заполнение формы регистрации 5](#заполнение-формы-регистрации)
>
> [2.3. Вход для ранее зарегистрированных пользователей
> 6](#вход-для-ранее-зарегистрированных-пользователей)

[3. Навигация по Панели пользователя
7](#навигация-по-панели-пользователя)

[4. Раздел «Профиль» 7](#раздел-профиль)

> [4.1. Персональные данные 7](#персональные-данные)
>
> [4.2. Детали следующего платежа 8](#детали-следующего-платежа)
>
> [4.3. Изменение уровня подписки на следующий месяц
> 8](#изменение-уровня-подписки-на-следующий-месяц)
>
> [4.4. Отмена подписки 8](#отмена-подписки)

[5. Раздел «Способ оплаты» 9](#раздел-способ-оплаты)

> [5.1. Просмотр текущей карты 9](#просмотр-текущей-карты)
>
> [5.2. Смена карты 9](#смена-карты)
>
> [5.3. Отмена подписки 10](#отмена-подписки-1)

[6. Раздел «Скачать приложение» 10](#_heading=h.smv3gi8ongpg)

> [6.1. Установка приложения 10](#установка-приложения)
>
> [6.2. Краткая инструкция по оформлению визита
> 11](#краткая-инструкция-по-оформлению-визита)

[7. Раздел «Контакты» 11](#_heading=h.q83ohzpaiktv)

[8. Раздел «Правовая информация и акты»
12](#раздел-правовая-информация-и-акты)

> [8.1. Правовая информация 12](#правовая-информация)
>
> [8.2. Скачивание акта 12](#скачивание-акта)

[9. Техническая поддержка 13](#_heading=h.6u7m80j09mtl)
