...
Subscriber panel (HR-портал) — это веб-инструмент для HR-менеджера компании, подключённой к сервису Allsports. Через него вы управляете подписками сотрудников, просматриваете статистику, работаете со счетами и актами.
...
B2B — компания полностью оплачивает подписку своих сотрудников. HR-менеджер сам формирует список сотрудников-подписчиков каждый месяц через Subscriber panel. Сотрудники не выполняют никаких действий для подключения.
...
Одна Subscriber panel может содержать несколько компаний разных типов, если юридически они оформлены отдельно.
