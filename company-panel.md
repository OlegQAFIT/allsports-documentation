...
Панель компании (HR-портал) — это веб-инструмент для HR-менеджера компании, подключённой к сервису Allsports. Через него вы управляете подписками сотрудников, просматриваете статистику, работаете со счетами и актами.
...
B2B — компания полностью оплачивает подписку своих сотрудников. HR-менеджер сам формирует список сотрудников-подписчиков каждый месяц через Панель компании. Сотрудники не выполняют никаких действий для подключения.
...
Одна Панель компании может содержать несколько компаний разных типов, если юридически они оформлены отдельно.
...
## 3. Навигация по Панели компании
...
![Иллюстрация](_assets/images/company-panel/image10.png)
1. скачать список сотрудников за предыдущий месяц

![Иллюстрация](_assets/images/company-panel/image11.png)
1. импортировать список сотрудников (по предложенному шаблону)

![Иллюстрация](_assets/images/company-panel/image12.png)
1. добавить сотрудника.

1. Кнопка «Сформировать счёт» — ручная генерация счёта на оплату

![Иллюстрация](_assets/images/company-panel/image13.png)
