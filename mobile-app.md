...
2. AppGallery (Huawei): appgallery.huawei.com/#/app/C104288727

3. Google Play (Android): play.google.com/store/apps/details?id=by.allsports.holder
...
2. В строке поиска введите «Allsports».

3. Нажмите «Установить» и дождитесь завершения загрузки.

4. Разрешите приложению доступ к геолокации — это необходимо для функции «Вход по локации».

5. Откройте приложение и выполните авторизацию.
...
2. Введите номер мобильного телефона, привязанный к вашей подписке.

3. Ознакомьтесь с Политикой обработки персональных данных и отметьте чекбокс для продолжения авторизации.
...
2. Если код не пришёл — дождитесь истечения таймера (1 минута) и нажмите «Повторить отправку SMS».
...
2. Lite — базовая подписка для Минска. Доступно 70+ объектов в столице и 20+ видов активностей: тренажёрные залы, фитнес и другие направления.

3. Classic — расширенная подписка. Доступно 600+ объектов по всей стране и 80+ вида активностей, включая танцы, стретчинг и боевые искусства.

4. Premium — подписка с расширенными возможностями. Доступно 780+ объектов и 110+ видов активностей: теннис, картинг, СПА и другие. Дополнительно предоставляется 4 визита в месяц в объекты из списка «Premium Plus» (значок PLUS на карте).

5. VIP — максимальный уровень подписки. Доступно 700+ объекта и 110+ видов активностей, включая массаж, конный спорт и сквош. Дополнительно предоставляется 4 визита в месяц в объекты из списка «VIP Plus».
...
2. При каждом посещении объекта администратор сверяет вашу фотографию в приложении с вашим внешним видом.

3. Система может периодически просить обновить фото — это плановая процедура.
...
2. Кружок с меткой PLUS — объект с расширенными (Plus) услугами.

3. Цифра в белом кружке — кластер нескольких объектов. Нажмите для приближения и просмотра каждого.
...
2. Бесплатная парковка — наличие бесплатной парковки для посетителей.

3. Доплата на объекте — объекты, на которых может потребоваться дополнительная оплата за отдельные услуги.

4. Круглосуточный — работающие 24 часа в сутки без выходных.

5. Wi-Fi — бесплатный беспроводной интернет.

6. Услуги для родителей с детьми — детская зона, детские программы или возможность прийти с ребёнком.

7. Сезонное обслуживание — работает только в определённый сезон.

8. Открыто сейчас — отображать только объекты, работающие в данный момент.
...
2. Сайт — открыть официальный сайт объекта в браузере.

3. Добраться — построить маршрут до объекта. При нажатии предлагается выбор: открыть в Google Maps или скопировать адрес.

4. Сохранить (значок закладки) — добавить объект в список «Избранное».
...
3. Объект будет добавлен в список избранного.
...
3. Наведите камеру телефона на QR-код Allsports, который находится у администратора объекта.

4. После успешного считывания QR-кода и выбора необходимой услуги визит будет зарегистрирован. Администратор проверит соответствие фотографии в приложении и вашей внешности. При невозможности идентификации по фотографии попросит предъявить документ, удостоверяющий личность.
...
2. Выберите «Вход по локации».

3. Разрешите приложению доступ к вашему местоположению.

4. Из предложенного списка ближайших объектов выберите нужный и подтвердите визит.
...
2. Избранные объекты — список сохранённых спортивных заведений.

3. Редактирование профиля — обновление фотографии для идентификации.

4. Выбор языка — смена языка интерфейса.

5. Выбор сервера — техническая настройка на случай проблем с подключением.

6. Техническая поддержка — контакты службы поддержки Allsports.

7. Информация — правовые документы сервиса.
...
2. Telegram — обращение через мессенджер Telegram
...
2. Правила осуществления платежей — порядок и условия оплаты услуг.

3. Договор возмездного оказания услуг — публичная оферта на оказание услуг.

4. Политика обработки персональных данных — информация о защите и обработке ваших персональных данных.

5. Правила оказания платёжной услуги — условия проведения платёжных операций.

6. Пользовательское соглашение — соглашение между пользователем и ООО «ОЛЛСПОРТС».

7. Сбор аналитики — информация о сборе и использовании аналитических данных приложения.
...
2. Email: support@allsports.by

3. Сайт: www.allsports.by

4. Instagram: instagram.com/allsports.by
