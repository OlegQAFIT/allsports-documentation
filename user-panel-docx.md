...
2. «Работодатель платит» — доля компании.

3. «Вы платите» — ваша доля (0,00 BYN, если компания покрывает стоимость полностью).
...
2. Укажите рабочую электронную почту в поле «Адрес корпоративной почты». Ее можно использовать для авторизации в качестве логина.

3. Введите мобильный номер телефона в поле «Номер телефона» — его также можно использовать для авторизации в качестве логина.

4. Выберите уровень из выпадающего списка в поле «Уровень подписки» (если доступно несколько вариантов).

5. Ознакомьтесь с Договором возмездного оказания услуг и Политикой обработки персональных данных — проставьте отметку в чекбоксе согласия.

6. Нажмите кнопку Продолжить.

7. После этого система направит письмо на указанный email. Откройте письмо и перейдите по ссылке для подтверждения адреса электронной почты.

8. После подтверждения email ваша заявка поступает к HR-менеджеру компании на рассмотрение. Дождитесь одобрения.
...
3. Введите SMS-код, поступивший на указанный номер телефона или корпоративный e-mail.
...
2. «Адрес корпоративной почты» — email, привязанный к подписке.

3. «Номер телефона» — ваш логин в мобильном приложении Allsports.

4. «Уровень подписки в текущем месяце» — тип подписки, действующей в этом месяце. Поле доступно только для чтения.

5. «Уровень подписки в следующем месяце» — выпадающий список для выбора уровня на следующий расчётный период.
...
2. «Работодатель платит» — сумма, которую компания берёт на себя.

3. «Вы платите» — ваша доля, которая будет списана с привязанной карты. В модели B2C, если компания покрывает подписку полностью, значение равно 0,00 BYN.
...
2. Выберите нужный уровень из доступных вариантов.

3. Проверьте данные в блоке «Подробности следующего платежа». После подтверждения запроса сотрудником HR в этом блоке отобразятся обновленные сведения.
...
2. Нажмите Закрыть — для возврата к профилю без изменений.
...
2. При ручном вводе заполните поля: «Номер карты», «Срок действия», «CVC», «Имя и фамилия на карте».
...
2. Google Play (Android) — для большинства Android-смартфонов.

3. AppGallery (Huawei) — для устройств Huawei без сервисов Google.

Для установки:

1. Наведите камеру смартфона на QR-код нужной платформы.

2. Перейдите по появившейся ссылке — откроется страница приложения в магазине.
...
5. Пройдите идентификацию — администратор сверит вашу фотографию в приложении.
...
3. «Договор возмездного оказания услуг на условиях публичной оферты» — основной договор между пользователем и ООО «ОЛЛСПОРТС».

4. «Политика в отношении обработки персональных данных ООО «ОЛЛСПОРТС»» — информация о защите ваших данных.

5. «Правила оказания платёжной услуги» — условия проведения платёжных операций.

6. «Пользовательское соглашение держателей карт Allsports» — соглашение для владельцев привязанных карт.
...
2. Название компании-работодателя.

3. Краткое описание проблемы и действия, которые к ней привели.
